package com.example.cv.permission.controller;
...
import com.example.cv.permission.service.PermissionService;
...
public class PermissionController {
    ...
    public Map<String, Object> create(@Valid @RequestBody PermissionRequests.CreateRequest request) {
        return service.create(request, SecurityUtils.currentUser());
    }

    @PatchMapping("/{id}")
    @ResponseMessage("Update a permission")
    public Object update(@PathVariable String id, @RequestBody PermissionRequests.UpdateRequest request) {
